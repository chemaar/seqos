...
function Snorql() {
   // this._endpoint = document.location.href.match(/^([^?]*)snorql\//)[1] + 'sparql';
    ...
    var D2R_namespacePrefixes = {
	    ...
	    "seqos-onto": 'http://purl.org/seerc/seqos/ontology/',
	    "seqos-index": 'http://purl.org/seerc/seqos/ontology/index/',
	    "seqos-component": 'http://purl.org/seerc/seqos/ontology/component/',
	    "seqos-indicator": 'http://purl.org/seerc/seqos/indicator/',	
	    "seqos-indicator-ext": 'http://purl.org/seerc/seqos/indicator/external/',    
	    "seqos-slice": 'http://purl.org/seerc/seqos/slice/',
	    "seqos-dsd": 'http://purl.org/seerc/seqos/dsd/',
	    "seqos-dataset": 'http://purl.org/seerc/seqos/dataset/',
	    "seqos-observation": 'http://purl.org/seerc/seqos/observation/',
	    "seqos-area": 'http://purl.org/seerc/seqos/area/area/',
	    "seqos-region": 'http://purl.org/seerc/seqos/area/region/',
	    "seqos-country": 'http://purl.org/seerc/seqos/area/country/',
	    "seqos-org": 'http://purl.org/seerc/seqos/organization/',    
